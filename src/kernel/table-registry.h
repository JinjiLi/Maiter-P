...
namespace dsm {
    ...
    static StateTable<K, V1, V2, V3>* CreateTable(double schedule_portion,
            Sharder<K>* sharder,
    ...
    template<class K, class V1, class V2, class V3>
    static StateTable<K, V1, V2, V3>* CreateTable(const TableDescriptor *info) {
        StateTable<K, V1, V2, V3> *t = (StateTable<K,V1,V2,V3>*)info->partition_factory->New();
        t->Init(info);
        return t;
    }
